...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Public author profile for posts and pages';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage editorial configuration';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredPosts: Schema.Attribute.Component<'layout.featured-posts', false>;
    ...
    sections: Schema.Attribute.DynamicZone<
      ['layout.hero', 'layout.featured-posts']
    >;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post for the developer site';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global configuration for the public developer site';
  ...
  attributes: {
    ...
    githubOwner: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'global::github-owner'> &
      Schema.Attribute.DefaultTo<'octocat'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'DevLog CMS'>;
    socialLinks: Schema.Attribute.Component<'shared.social-link', true>;
...
export interface ApiStaticPageStaticPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Simple editorial page for the public site';
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Topic label for posts';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface PluginGithubShowcaseProject
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    forks: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::github-showcase.project'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    openIssues: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    publishedAt: Schema.Attribute.DateTime;
    pushedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::github-showcase.project': PluginGithubShowcaseProject;
